...
export default function Home() {
  return (
    <>
      <div className="flex  pl-52 pt-52 h-screen  bg-gradient-to-r  from-violet-300 to-fuchsia-300">
        <img
        ...
        <div className="flex flex-col items-center ">
          <div className="flex flex-col border-2 border-slate-400 items-center w-[450px] h-64 bg-violet-200 rounded-2xl ml-48">
          ...
          <Link
            className="rounded-xl font-lalezar w-40 h-10 text-center ml-48 mt-5 flex items-center justify-center hover:bg-blue-500 active:translate-y-1 bg-start-cyan text-white"
            href={"/Index"}
          >
            LET'S GO!
          </Link>
