                    ...
                    if (
                      ...
                      return (
                        ...
                        >
                          ...
                          <button
                            id="claimButton"
                            className="rounded-full w-56 h-8 text-white font-lalezar hover:opacity-80 active:translate-y-0.5 bg-violets transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-150  m-2"
                            onClick={(e) => {
